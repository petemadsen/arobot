...
#define PROJECT_VERSION "2020-04-25/0"
...
#define PROJECT_WS2812B_PIN			GPIO_NUM_33
#define PROJECT_WS2812B_POWER_PIN	GPIO_NUM_27


#define PROJECT_I2C_BOARD_BMP280	0x77
